...
var Album = function (_React$Component) {
    ...
    _createClass(Album, [{
        ...
        value: function componentDidMount() {
            ...
            fetch('http://' + _connection2.default.HOST + ':' + _connection2.default.PORT + '/spotify/details/' + album.id, {}).then(function (response) {
                if (response.ok) {
                    return response.json();
                }
            }).then(function (data) {
                _this2.setState({ details: JSON.parse(data), isLoading: false });
            }).catch(function (error) {
                return _this2.setState({ error: error, isLoading: false });
            });
        }
    }, {
        key: 'getStarsFromPopularity',
        value: function getStarsFromPopularity(popularity) {
            var popularityOutOf5 = Math.floor(popularity * 0.05);
            var stars = [];
        ...
        value: function render() {
            ...
            var genreArray = details.genre || this.props.artistGenre || []; // if album has no genre, take artist's
            var genre = genreArray.length ? genreArray[0] : ""; // take first genre

            var releaseDate = details.release_date ? new Date(details.release_date).getFullYear() : 0;
            var stars = this.getStarsFromPopularity(details.popularity);
            var tracks = details.tracks ? details.tracks.items : [];
            ...
            var artist = this.props.newrelease && album.artists.length ? album.artists[0] : null;
                ...
                _react2.default.createElement(
                    ...
                    artist ? _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { key: artist.id, to: { pathname: '/artists/' + artist.id } },
                            artist.name
                        )
                    ) : null,
                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        tracks.map(function (track) {
                            return _react2.default.createElement(
                                'li',
                                { key: track.id },
                                _react2.default.createElement(_Track2.default, { track: track, albumName: album.name, image: image.url })
                            );
                        })
                    )
                )
...
var _ArtistList = __webpack_require__(79);

var _ArtistList2 = _interopRequireDefault(_ArtistList);

var _Artist = __webpack_require__(82);

var _Artist2 = _interopRequireDefault(_Artist);

var _NewReleases = __webpack_require__(84);
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                null,
                                _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _ArtistList2.default }),
                                _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/artists', component: _ArtistList2.default }),
                                _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/newreleases', component: _NewReleases2.default }),
...
var _ArtistItem = __webpack_require__(80);

var _ArtistItem2 = _interopRequireDefault(_ArtistItem);
...
var ArtistList = function (_React$Component) {
    ...
    function ArtistList(props) {
        ...
        var _this = _possibleConstructorReturn(this, (ArtistList.__proto__ || Object.getPrototypeOf(ArtistList)).call(this, props));
    ...
    _createClass(ArtistList, [{
        ...
        value: function handleSearch(query) {
            ...
            fetch('http://' + _connection2.default.HOST + ':' + _connection2.default.PORT + '/spotify/search', {
                method: 'post',
                ...
                if (_this2.state.hits.length) {
                    _this2.props.history.push('/artists?q=' + query, { artistQuery: query }); // push query on history

                    _this2.setState({ headline: "Search results for: " + query });
                } else {
                    _this2.setState({ headline: "No results found for: " + query });
                }
            }).catch(function (error) {
                return _this2.setState({ error: error, isLoading: false });
            });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_Search2.default, { query: 'Artists',
                ...
                _react2.default.createElement(
                    ...
                    hits.map(function (a) {
                        return _react2.default.createElement(
                            _reactRouterDom.Link,
                            { key: a.id, to: { pathname: '/artists/' + a.id } },
                            _react2.default.createElement(
                                'div',
                                { className: 'artist' },
                                _react2.default.createElement(_ArtistItem2.default, { artist: a })
                            )
                        );
                    })
                )
...
var ArtistItem = function (_React$Component) {
    _inherits(ArtistItem, _React$Component);

    function ArtistItem() {
        _classCallCheck(this, ArtistItem);

        return _possibleConstructorReturn(this, (ArtistItem.__proto__ || Object.getPrototypeOf(ArtistItem)).apply(this, arguments));
    }
...
var Artist = function (_React$Component) {
    ...
    _createClass(Artist, [{
        ...
        value: function fetchArtist(artistId) {
            ...
            fetch('http://' + _connection2.default.HOST + ':' + _connection2.default.PORT + '/spotify/artists/' + artistId, {}).then(function (response) {
                if (response.ok) {
                    return response.json();
                }
            }).then(function (data) {
                _this2.setState({ artist: JSON.parse(data), isLoading: false });
            }).catch(function (error) {
                return _this2.setState({ error: error, isLoading: false });
            });
        }
    }, {
        key: 'fetchArtistAlbums',
        value: function fetchArtistAlbums(artistId) {
            var _this3 = this;

            fetch('http://' + _connection2.default.HOST + ':' + _connection2.default.PORT + '/spotify/albums/' + artistId, {}).then(function (response) {
                if (response.ok) {
                    return response.json();
                }
            }).then(function (data) {
                _this3.setState({ albums: JSON.parse(data), isLoading: false });
            }).catch(function (error) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    albums.map(function (al) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'album', key: al.id },
                            _react2.default.createElement(_Album2.default, { album: al, artistGenre: artist.genres })
                        );
                    })
                )
            );
...
var Track = function (_React$Component) {
    ...
    _createClass(Track, [{
        key: 'toggleTrackPopup',
        value: function toggleTrackPopup() {
            this.setState({ showPopup: !this.state.showPopup });
        }
    }, {
        key: 'msToMinutesSeconds',
        value: function msToMinutesSeconds(ms) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { onClick: this.toggleTrackPopup.bind(this) },
                    track.name
                ),
                _react2.default.createElement(
                    'div',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        track.track_number,
                                        ' Duration: ',
                                        this.msToMinutesSeconds(track.duration_ms)
                                    )
                                ),
                                _react2.default.createElement(
                                    'div',
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'player' },
                                        track.is_playable ? _react2.default.createElement(
                                            'audio',
                                            { controls: 'controls' },
                                            _react2.default.createElement('source', { src: track.preview_url, type: 'audio/mpeg' })
                                        ) : _react2.default.createElement(
                                            'div',
                                            null,
                                            'Not playable'
...
var NewReleases = function (_React$Component) {
    _inherits(NewReleases, _React$Component);

    function NewReleases(props) {
        _classCallCheck(this, NewReleases);

        var _this = _possibleConstructorReturn(this, (NewReleases.__proto__ || Object.getPrototypeOf(NewReleases)).call(this, props));
    ...
    _createClass(NewReleases, [{
        ...
        value: function componentDidMount() {
            ...
            fetch('http://' + _connection2.default.HOST + ':' + _connection2.default.PORT + '/spotify/newrelease', {}).then(function (response) {
                if (response.ok) {
                    return response.json();
                }
            }).then(function (data) {
                _this2.setState({ newAlbums: JSON.parse(data), isLoading: false });
            }).catch(function (error) {
                return _this2.setState({ error: error, isLoading: false });
            });
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'album-container' },
                    newAlbums.map(function (al) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'album', key: al.id },
                            _react2.default.createElement(_Album2.default, { album: al, newrelease: true })
                        );
                    })
                )
            );
...
// module
exports.push([module.i, "body, button, input {\n  background-color: #602f6b;\n  color: #ffffff;\n  font-family: \"Ubuntu\", sans-serif; }\n\nul {\n  list-style-type: none; }\n\na {\n  text-decoration: none;\n  color: #ffffff; }\n\nh1 {\n  text-align: center; }\n\nh1.banner {\n  font-size: 40px; }\n\nh2 {\n  color: #ffffff;\n  text-align: center; }\n\nheader {\n  text-align: center; }\n  header nav ul {\n    padding-left: 0; }\n    header nav ul li {\n      display: inline-block;\n      box-sizing: border-box;\n      margin: 20px;\n      padding: 0 5px;\n      border: 2px solid #ffffff;\n      border-radius: 5px; }\n      header nav ul li:hover {\n        color: #602f6b;\n        background-color: #ffffff; }\n\n.container {\n  width: 75%;\n  margin: 0 auto; }\n\ninput, button {\n  border-radius: 5px;\n  padding: 5px;\n  margin: 5px;\n  font-weight: bold; }\n\n.search {\n  text-align: center; }\n  .search input {\n    width: 50%;\n    min-width: 200px;\n    font-size: 20px; }\n\n.artists-container {\n  display: flex;\n  flex-flow: row wrap;\n  justify-content: center;\n  align-items: stretch; }\n  .artists-container a {\n    color: #602f6b; }\n  .artists-container .artist {\n    width: 250px;\n    padding: 20px;\n    height: 100px;\n    background-color: #ffffff;\n    margin: 10px; }\n    .artists-container .artist img {\n      width: 100px;\n      height: 100px;\n      float: left;\n      margin-right: 20px; }\n    .artists-container .artist .artist-name {\n      margin-left: 20px; }\n\n.album-container {\n  display: flex;\n  flex-flow: row wrap;\n  justify-content: center;\n  align-items: flex-start; }\n\n.album {\n  width: 250px;\n  padding: 20px;\n  background-color: #ffffff;\n  margin: 10px 15px;\n  color: #602f6b;\n  text-align: center; }\n  .album a {\n    color: #602f6b; }\n  .album:hover .tracks {\n    max-height: 500px; }\n  .album img {\n    width: 100%;\n    height: 200px; }\n  .album .album-details {\n    display: block;\n    overflow: hidden; }\n    .album .album-details .artist-link {\n      margin-top: 10px; }\n      .album .album-details .artist-link a {\n        text-decoration: underline; }\n    .album .album-details .album-name {\n      margin: 10px auto;\n      overflow: hidden;\n      text-overflow: ellipsis;\n      width: 200px;\n      white-space: nowrap; }\n    .album .album-details .genre {\n      font-size: 12px; }\n    .album .album-details .stars {\n      float: left;\n      width: 50%;\n      text-align: left; }\n    .album .album-details .date {\n      float: right;\n      text-align: right;\n      width: 50%; }\n  .album .arrowDown {\n    font-size: 20px; }\n  .album .tracks {\n    font-size: 12px;\n    text-align: left;\n    padding: 5px;\n    display: block;\n    overflow-y: hidden;\n    max-height: 0;\n    transition: max-height 0.7s ease-in-out; }\n    .album .tracks ol {\n      padding-left: 15px; }\n      .album .tracks ol li {\n        cursor: pointer; }\n        .album .tracks ol li:hover {\n          text-decoration: underline; }\n    .album .tracks .track {\n      position: relative; }\n      .album .tracks .track .popup {\n        position: fixed;\n        width: 100%;\n        height: 100%;\n        top: 0;\n        left: 0;\n        right: 0;\n        bottom: 0;\n        margin: auto;\n        background-color: rgba(0, 0, 0, 0.5);\n        display: flex;\n        flex-flow: column wrap;\n        justify-content: center;\n        align-items: center; }\n      .album .tracks .track .popup_inner {\n        width: 300px;\n        margin: auto;\n        background: #602f6b;\n        color: #ffffff;\n        padding: 10px; }\n        .album .tracks .track .popup_inner h1, .album .tracks .track .popup_inner h2, .album .tracks .track .popup_inner h3 {\n          margin: 5px auto;\n          text-align: center; }\n        .album .tracks .track .popup_inner .popup_container {\n          display: flex;\n          flex-flow: column wrap;\n          justify-content: center;\n          align-items: center; }\n          .album .tracks .track .popup_inner .popup_container .close-button-right button {\n            background-color: #ffffff;\n            color: #602f6b; }\n          .album .tracks .track .popup_inner .popup_container .media-bottom {\n            padding-top: 10px; }\n            .album .tracks .track .popup_inner .popup_container .media-bottom a {\n              color: #ffffff; }\n            .album .tracks .track .popup_inner .popup_container .media-bottom img {\n              width: 250px; }\n            .album .tracks .track .popup_inner .popup_container .media-bottom .player {\n              margin: 10px 0px; }\n              .album .tracks .track .popup_inner .popup_container .media-bottom .player audio {\n                width: 100%; }\n", ""]);

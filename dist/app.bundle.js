...
var _Track = __webpack_require__(82);
...
var Album = function (_React$Component) {
    ...
    _createClass(Album, [{
        ...
        value: function componentDidMount() {
            ...
            fetch('http://localhost:3000/spotify/details/' + album.id, {}).then(function (response) {
                if (response.ok) {
...
var _ArtistList = __webpack_require__(78);

var _ArtistList2 = _interopRequireDefault(_ArtistList);

var _Artist = __webpack_require__(81);

var _Artist2 = _interopRequireDefault(_Artist);

var _NewReleases = __webpack_require__(83);
...
var _ArtistItem = __webpack_require__(79);
...
var Artist = function (_React$Component) {
    ...
    _createClass(Artist, [{
        ...
        value: function fetchArtist(artistId) {
            ...
            fetch("http://localhost:3000/spotify/artists/" + artistId, {}).then(function (response) {
                if (response.ok) {
                    return response.json();
                }
            }).then(function (data) {
        ...
        value: function fetchArtistAlbums(artistId) {
            ...
            fetch("http://localhost:3000/spotify/albums/" + artistId, {}).then(function (response) {
                if (response.ok) {
                    return response.json();
                }
            }).then(function (data) {
...
var NewReleases = function (_React$Component) {
    ...
    _createClass(NewReleases, [{
        ...
        value: function componentDidMount() {
            ...
            fetch('http://localhost:3000/spotify/newrelease', {}).then(function (response) {
                if (response.ok) {
                    return response.json();
                }
            }).then(function (data) {
